...
\begin{tabular}{ l l }
	...
	\descript{Platforms}             & {\location{Kubernetes, Cloud Foundry, AWS, Android, iOS, Linux, Splunk, Gitlab, Azure DevOps, JIRA}}      \\
	\descript{Technologies}          & {\location{Docker, Kafka, Vault, TPM, ARM Trustzone, Postgres, Mongo}}     \\
	\descript{Concepts}              & {\location{CI/CD, DevOps, IaC, Microservices, Regression Testing}}                   \\
	\descript{Certifications}		 & {\location{CompTIA Security+, SAFe Program Consultant 4/5, Scrummaster, Scrum@Scale Practitioner}} \\
...
\runsubsection{Raft}\descript{| Manager, Platform Engineer}\hfill \location{Hampton, VA | July 2024 – Current}
\begin{tightemize}
	\item Manage a team of platform engineers that build and maintain the Air Force's Kessel Run platform (Cloud Foundry).
\end{tightemize}
\sectionsep
\runsubsection{Qualcomm}\descript{| Staff DevOps Engineer}\hfill \location{San Diego, CA | Oct 2022 – July 2024}
\begin{tightemize}
...
\end{tightemize}
\sectionsep
\runsubsection{MITRE}\descript{| Software Engineering Manager}\hfill \location{San Diego, CA | Aug 2015 – June 2022}
\begin{tightemize}
...
\end{tightemize}
\sectionsep
\runsubsection{MITRE}\descript{| Lead Software Engineer}\hfill \location{Hampton, VA | Mar 2014 – Apr 2018}
\begin{tightemize}
...
\end{tightemize}
\sectionsep
\runsubsection{MITRE}\descript{| Senior Software Engineer}\hfill \location{Hampton, VA | June 2008 – Mar 2014}
\begin{tightemize}
